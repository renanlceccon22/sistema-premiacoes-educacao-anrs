        ...
        {!isReadOnly && isEditMode && (
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 rounded-xl font-black text-xs transition-all uppercase tracking-widest shadow-md bg-green-600 text-white hover:bg-green-700"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
