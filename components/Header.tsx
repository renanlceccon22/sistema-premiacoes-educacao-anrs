...
const Header: React.FC<HeaderProps> = ({
  ...
  // Filtra as abas: Super Admin sempre vê tudo. Admin vê abas de admin. Usuário comum vê o básico.
  const visibleTabs = isSuperAdmin ? tabs : (isAdmin ? tabs : tabs.filter(t => t.id !== 'MASTER_VALUES' && t.id !== 'COST_ANALYSIS'));
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
          ...
          <div className="hidden lg:flex items-center gap-3 lg:min-w-[20%] justify-end">
            ...
            <div className="flex items-center gap-2">
              ...
              {!impersonatedEmail && isSuperAdmin && (
                <button
